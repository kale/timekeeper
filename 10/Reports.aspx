<%@ Page Language="C#" MasterPageFile="~/10/Site.master" AutoEventWireup="true" CodeFile="Reports.aspx.cs"
    Inherits="Reports" %>
    ...
    <div id="gridview">
        ...
        <asp:MultiView ID="MainMultiView" runat="server" Visible="true">
            ...
            <asp:View ID="ByDetailedReports" runat="server">
                <br />
                <!-- put reporting service below or just remove -->
                <iframe id="iFrameView" src="REPORT_SERVER"
                    runat="server" width="100%" height="800px" frameborder="0"></iframe>
            </asp:View>
        </asp:MultiView>
    </div>
