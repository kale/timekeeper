...
public class ProjectsBLL
{
    ...
    public bool AddProject(int projectID, string projectNumber, string name, string teamsiteURL, bool active, int phaseID, string projectManager)
    {
    ...
    public bool AddProject(int projectID, string projectNumber, string name, bool active, int phaseID, string projectManager)
    {
        //Create a new ProjectRow instance
        TimeKeeper.ProjectsDataTable projects = new TimeKeeper.ProjectsDataTable();
        TimeKeeper.ProjectsRow project = projects.NewProjectsRow();
    ...
    public bool UpdateProject(int projectID, string projectNumber, string name, string teamsiteURL, bool active, int phaseID, string projectManager)
    {
